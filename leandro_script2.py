...
model.add(layers.LSTM(50, activation=keras.layers.LeakyReLU(alpha=0.05), input_shape=(X_train_scaled.shape[1], X_train_scaled.shape[2])))
...
# Train the model
model.fit(X_train_scaled, y_train, epochs=5, batch_size=4, validation_data=(X_test_scaled, y_test))
